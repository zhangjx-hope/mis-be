...
//            // 解密私钥 私密与密码相同
//            byte[] encryptedPrivateKey = Base64.getDecoder().decode(sysUser.getPrivateKeyBytes());
//            byte[] privateBytes = AESUtils.decrypt(encryptedPrivateKey, sysUser.getPassword());
...
//            // 操作日志签名示例
//            String log = "用户" + sysUser.getUsername() + "登录日志";
//            byte[] signature = signLog(privateKey, log);
//            if (signature != null) {
//                System.out.println("登录日志签名成功");
//            } else {
//                System.out.println("登录日志签名失败");
//            }
//
//            //验证签名
//            Boolean flag = false;
//            flag = verifyLog(sysUser.getUsername(), log, signature);
//            if (flag) {
//                System.out.println("登录日志签名验证成功");
//            } else {
//
//                System.out.println("登录日志签名验证失败");
//            }
            return result;
        } catch (Exception e) {
